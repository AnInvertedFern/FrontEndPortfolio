...
export class TitlesComponent implements OnInit{
  ...
  public ngOnInit() : void {
    ...
    newStyle.textContent = `
      .titles{ overflow:visible; display:flex; justify-content:center; height:100%; }
      ...
      .title-column{ height:100%; overflow:auto; display:flex; flex:1; flex-direction:column; align-items:center; }
